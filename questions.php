...
if(isset($_POST['envoi'])){
    if(!empty($_POST['description'])){
        ...
        $insererQuestion=$bdd->prepare('INSERT INTO questions(description)VALUES(?)');
        ...
        echo "<h4 class=\"h4\" >veuiller poser la question</h4>";
    }
}
...
<textarea name="description" id="put"placeholder="Votre Question"></textarea><br><br>
